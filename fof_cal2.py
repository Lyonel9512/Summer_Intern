...
port_information = pd.read_excel(
    './【中信建投证券】风格组合持仓明细.xlsx', header=0, sheet_name=0, index_col=0)
#port_information = pd.read_csv('./qz.csv', index_col=0)
daily, dailyf, weekly, monthly, weeklyf, monthlyf, output = get_netvalue(
    all_data, port_information, dic_data, 200000000, 30)
# plt.plot(daily)
# plt.plot(dailyf)
